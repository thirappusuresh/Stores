...
class ClientCustomersController extends Controller
{
	...
	{
		$model=new ClientCustomers('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ClientCustomers']))
			$model->attributes=$_GET['ClientCustomers'];
	...
	{
		$model=ClientCustomers::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='client-customers-form')
		{
